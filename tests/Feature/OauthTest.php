...
namespace MelhorEnvio\MelhorEnvio\Feature\Unit;
...
class OauthTest extends TestCase
{
    ...
    /** @test */
    public function should_return_path_when_use_method_get_endpoint()
    {
        $this->assertEquals($this->provider->getEndpoint(), "https://sandbox.melhorenvio.com.br");
    }

    /** @test */
    public function should_return_ok_when_use_method_set_environment()
    {
    ...
    /** @test */
    public function should_return_an_url_when_use_method_get_authorization_url()
    {
    ...
    /** @test */
    public function should_return_scopes_when_use_method_get_scopes()
    {
    ...
    /** @test */
    public function should_return_redirect_url_when_use_methods_to_change_redirect_url()
    {
